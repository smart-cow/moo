...
(function() {
  var GreeterCtrl, GreeterCtrl2, WorkflowTreeCtrl,
  ...
  GreeterCtrl = (function(_super) {
    ...
    function GreeterCtrl() {
      this.init = __bind(this.init, this);
      return GreeterCtrl.__super__.constructor.apply(this, arguments);
    }
    ...
    GreeterCtrl.prototype.init = function(arg) {
      var _ref;
      return this.customer = {
        name: (_ref = arg != null ? arg.name : void 0) != null ? _ref : "Naomi",
        address: "1600 ARoad"
      };
    };
  ...
  GreeterCtrl2 = (function(_super) {
    __extends(GreeterCtrl2, _super);

    GreeterCtrl2.register(angular.module("moo.directives"));

    GreeterCtrl2.inject("$scope", "Tasks");

    function GreeterCtrl2($scope, MyTasks) {
      this.greet = __bind(this.greet, this);
      var _ref;
      this.customer = {
        name: (_ref = $scope != null ? $scope.name : void 0) != null ? _ref : "Naomi",
        address: "1600 ARoad"
      };
      m$log("init tasks", MyTasks);
    }

    GreeterCtrl2.prototype.greet = function() {
